...
from data.datasets import ArtifactPriorImageDataset, artifact_prior_collate, collect_labeled_images, limit_per_label
...
def extract_features(
    ...
    samples = limit_per_label(collect_labeled_images(source_root), int(max_samples_per_label))
    ...
    extractor.eval()
    dataset = ArtifactPriorImageDataset(samples, image_size=int(image_size), variant=train_variant)
    loader = DataLoader(
        dataset,
