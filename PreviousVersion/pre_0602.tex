...
\begin{table*}[!t]
\caption{Comparison on UniversalFakeDetect. Each entry reports Acc/AP (\%) for detecting real and fake images from the subset named in the column. Mean averages the shared subsets.}
\label{tab:ufd_report}
\centering
\tiny
\providecommand{\rotgen}[1]{\makebox[0pt][l]{\rotatebox{60}{\textit{#1}}}}
\providecommand{\pair}[2]{\shortstack[c]{#1\\#2}}
\renewcommand{\arraystretch}{1.05}
\setlength{\tabcolsep}{1.0pt}
\begin{tabularx}{\textwidth}{@{}l>{\centering\arraybackslash}p{0.057\textwidth}*{20}{Y}@{}}
\toprule
Method & Ref. & \rotgen{ProGAN} & \rotgen{CycleGAN} & \rotgen{BigGAN} & \rotgen{StyleGAN} & \rotgen{GauGAN} & \rotgen{StarGAN} & \rotgen{Deepfake} & \rotgen{SITD} & \rotgen{SAN} & \rotgen{CRN} & \rotgen{IMLE} & \rotgen{Guided} & \rotgen{LDM200} & \rotgen{LDM200-CFG} & \rotgen{LDM100} & \rotgen{GLIDE100-27} & \rotgen{GLIDE100-10} & \rotgen{GLIDE50-27} & \rotgen{DALL-E} & \rotgen{Mean} \\
\midrule
CNNSpot & CVPR~2020 & \pair{99.99}{100.00} & \pair{85.20}{93.47} & \pair{70.20}{84.50} & \pair{85.70}{99.54} & \pair{78.95}{89.49} & \pair{91.70}{98.15} & \pair{53.47}{89.02} & \pair{66.67}{73.75} & \pair{48.69}{59.47} & \pair{86.31}{98.24} & \pair{86.26}{98.40} & \pair{60.07}{73.72} & \pair{54.03}{70.62} & \pair{54.96}{71.00} & \pair{54.14}{70.54} & \pair{60.78}{80.65} & \pair{63.80}{84.91} & \pair{65.66}{82.07} & \pair{55.58}{70.59} & \pair{69.58}{83.58} \\
LGrad & CVPR~2023 & \pair{99.84}{100.00} & \pair{85.39}{93.98} & \pair{82.88}{90.69} & \pair{94.83}{99.86} & \pair{72.45}{79.36} & \pair{99.62}{99.98} & \pair{58.00}{67.91} & \pair{62.50}{59.42} & \pair{50.00}{51.42} & \pair{50.74}{63.52} & \pair{50.78}{69.61} & \pair{77.50}{87.06} & \pair{94.20}{99.03} & \pair{95.85}{99.16} & \pair{94.80}{99.18} & \pair{87.40}{93.23} & \pair{90.70}{95.10} & \pair{89.55}{94.93} & \pair{88.35}{97.23} & \pair{80.28}{86.35} \\
NPR & CVPR~2024 & \pair{99.84}{100.00} & \pair{95.00}{99.53} & \pair{87.55}{94.53} & \pair{96.23}{99.94} & \pair{86.57}{88.82} & \pair{99.75}{100.00} & \pair{76.89}{84.41} & \pair{66.94}{97.95} & \pair{98.63}{99.99} & \pair{50.00}{50.16} & \pair{50.00}{50.16} & \pair{84.55}{98.26} & \pair{97.65}{99.92} & \pair{98.00}{99.91} & \pair{98.20}{99.92} & \pair{96.25}{99.87} & \pair{97.15}{99.89} & \pair{97.35}{99.92} & \pair{87.15}{99.26} & \pair{87.56}{92.76} \\
UnivFD & CVPR~2023 & \pair{100.00}{100.00} & \pair{98.50}{98.13} & \pair{94.50}{94.46} & \pair{82.00}{86.66} & \pair{99.50}{99.25} & \pair{97.00}{99.53} & \pair{66.60}{91.67} & \pair{63.00}{78.54} & \pair{57.50}{67.54} & \pair{59.50}{83.12} & \pair{72.00}{91.06} & \pair{70.03}{79.24} & \pair{94.19}{95.81} & \pair{73.76}{79.77} & \pair{94.36}{95.93} & \pair{79.07}{93.93} & \pair{79.85}{95.12} & \pair{78.14}{94.59} & \pair{86.78}{88.45} & \pair{81.38}{90.14} \\
FatFormer & CVPR~2024 & \pair{99.89}{100.00} & \pair{99.32}{100.00} & \pair{99.50}{99.98} & \pair{97.15}{99.75} & \pair{99.41}{100.00} & \pair{99.75}{100.00} & \pair{93.23}{97.99} & \pair{81.11}{97.94} & \pair{68.04}{81.21} & \pair{69.45}{99.84} & \pair{69.45}{99.93} & \pair{76.00}{91.99} & \pair{98.60}{99.81} & \pair{94.90}{99.09} & \pair{98.65}{99.87} & \pair{94.35}{99.13} & \pair{94.65}{99.41} & \pair{94.20}{99.20} & \pair{98.75}{99.82} & \pair{90.86}{98.16} \\
RINE & ECCV~2024 & \pair{100.00}{100.00} & \pair{99.30}{100.00} & \pair{99.60}{99.90} & \pair{88.90}{99.40} & \pair{99.80}{100.00} & \pair{99.50}{100.00} & \pair{80.60}{97.90} & \pair{90.60}{97.20} & \pair{68.30}{94.90} & \pair{89.20}{97.30} & \pair{90.60}{99.70} & \pair{76.10}{96.40} & \pair{98.30}{99.80} & \pair{88.20}{98.30} & \pair{98.60}{99.90} & \pair{88.90}{98.80} & \pair{92.60}{99.30} & \pair{90.70}{98.90} & \pair{95.00}{99.30} & \pair{91.31}{98.78} \\
C2P-CLIP & AAAI~2025 & \pair{99.98}{100.00} & \pair{97.31}{100.00} & \pair{99.12}{99.96} & \pair{96.44}{99.50} & \pair{99.17}{100.00} & \pair{99.60}{100.00} & \pair{93.77}{98.59} & \pair{95.56}{98.92} & \pair{64.38}{84.56} & \pair{93.29}{99.86} & \pair{93.29}{99.95} & \pair{69.10}{94.13} & \pair{99.25}{99.99} & \pair{97.25}{99.83} & \pair{99.30}{99.98} & \pair{95.25}{99.72} & \pair{95.25}{99.79} & \pair{96.10}{99.83} & \pair{98.55}{99.91} & \pair{93.79}{98.66} \\
\midrule
\rowcolor[gray]{0.88}
Ours & -- & \pair{99.99}{100.00} & \pair{96.59}{99.83} & \pair{89.33}{99.27} & \pair{99.34}{100.00} & \pair{82.84}{99.51} & \pair{99.87}{100.00} & \pair{80.35}{94.85} & \pair{69.44}{99.19} & \pair{92.24}{97.51} & \pair{50.02}{99.05} & \pair{50.02}{99.90} & \pair{90.05}{98.29} & \pair{99.30}{99.98} & \pair{97.30}{99.86} & \pair{99.45}{99.99} & \pair{99.45}{99.96} & \pair{99.15}{99.90} & \pair{99.35}{99.95} & \pair{93.95}{99.61} & \pair{88.84}{99.30} \\
\bottomrule
\end{tabularx}
\end{table*}
